...
def get_rate_confirmation_schema():
    rate_confirmation_schema = {
                                    ...
                                    "sender": "cornerstone_systems",  # BROKER or SHIPPER if they are not having a broker. Example: "Werner Logistics"
                                    "receiver": {
                                                "name": None,  # carrier-name on top right of page
                                                "isa_qual": "ZZ",  # hard-coded
                                                "isa_ID": None  # client email
                                                },
                                    "client": "cornerstone_systems",  # hard-coded. Example: "Werner Logistics"
                                    "submitted_time": None,     # time we received the email
                                    "identifier": None,
                                    "identifier_type": "shipment #",
                                    "shipment": {
...
def get_entity_schema(entity_type):
    entity_schema = { 
                        ...
                        "address": None,     # List object ['address part 1', 'address part 2']
                        "city": None,
                        "state": None,
                        "postal": None,
                        "country": "U.S",
...
def get_purchase_order_schema():
    purchase_order_schema = {
                                ...
                                "date": None,
                                "cases": None,  # quantity
                                "weight_unit_code": "L",  # "L" for pounds, "K" for Kilo
                                "weight": None,
